...
const Footer = () => {
    return <div className="social">
        ...
        <ul>
            <li><a href="https://www.linkedin.com/in/daneil-coulthard/" target="_blank" rel="noopener noreferrer" alt="FB"><i className="fab fa-linkedin" aria-hidden="false" ></i></a></li>
